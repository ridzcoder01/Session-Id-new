...
router.get('/', async (req, res) => {
    ...
    async function NEBULA_ASSASSIN_PAIR_CODE() {
        const {
            state,
            saveCreds
    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hey there, NEBULA ASSASSIN User!* 👋🏻

Thanks for using *NEBULA ASSASSIN* — your session has been successfully created!
...
{quoted:ddd })
   ...
   return await NEBULA_ASSASSIN_PAIR_CODE();
});/*
setInterval(() => {
